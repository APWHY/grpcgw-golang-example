...
func request_EventService_PostEvent_0(ctx context.Context, marshaler runtime.Marshaler, client EventServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterEventServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client EventServiceClient) error {
	...
	mux.Handle("POST", pattern_EventService_PostEvent_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_EventService_PostEvent_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_EventService_PostEvent_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_EventService_PostEvent_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api", "event"}, ""))
)

var (
	forward_EventService_PostEvent_0 = runtime.ForwardResponseMessage
)
